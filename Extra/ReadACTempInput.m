% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% This script reads all the AquaCrop data from .....TMP files. 
%
...
function [output]= ReadACTempInput(Datapath)
...
Datafile=dir(fullfile(Datapath,'*.TMP'));
       ...
       % read real data line by line
            ...
            TextLine=fgetl(fid); %get a textline from the file 
               ...
               while isempty(TextLine)==0 %as long there is no blank space in TextLine (blank space indicating the end of a project)
                    ...
                    output{2,filenumb} (linecounter,1:2) = LineData'; % write the data of this line
