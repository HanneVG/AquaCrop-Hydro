...
%% ------------------------------------------------------------------------
% 0. DEFINE DATA PATHS  & AquaCrop Mode                                                  %
%--------------------------------------------------------------------------      
...
%    b) yield data for every AquaCrop simulation unit and run
    ...
    DatapathOutput=uigetdir('C:\','Select directory to store evaluation output & yield output');
...
filename = fullfile(DatapathOutput, name);
...
filename2 = fullfile(DatapathOutput, name2);
