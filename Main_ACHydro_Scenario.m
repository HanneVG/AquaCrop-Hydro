...
% 11.1 Summary of annual discharge 
% -----------------------------------------------------------------------  
...
% 11.2 Summary of monthly total flow 
% ----------------------------------------------------------------------- 
...
% 11.3 Summary of Crop development and production parameters
% -----------------------------------------------------------------------     
...
% 11.5 Summary of CV yield, WPET and flow
% ----------------------------------------------------------------------- 
...
% FIGURE 5: BOXPLOT YIELD AND WPET CHANGES (per crop)
%-------------------------------------------------------------------------
...
% FIGURE 9: BOXPLOT DSI CHANGES 
%-------------------------------------------------------------------------
f9=figure('name','Figure 9 - DSI boxplot');
        sub(1)=subplot(1,5,1,'fontsize',10);
...
savefig(f4,filename)      
filename=fullfile(DatapathScenOut,'Figure 5 - Productivity boxplot');
savefig(f5,filename)      
...
savefig(f8,filename)      
filename=fullfile(DatapathScenOut,'Figure 9 - DSI boxplot');
savefig(f9,filename)      
