...
%-------------------------------------------------------------------------
% f1adapt=figure('name','Median yield changes');%(boxplot= variation over different GCMs) 
%         sub(1)=subplot(1,5,1,'fontsize',10);
%         boxplot(YactDeltastats{2,maize}(2,2:nsc)*100,groupmat(1,2:nsc),'grouporder',groupnames,'labels',{'ens','Hs','Hw','L','M'});
...
%         boxplot(YactDeltastats{2,wwheat}(2,2:nsc)*100,groupmat(1,2:nsc),'grouporder',groupnames,'labels',{'ens','Hs','Hw','L','M'});
%         line(xlim,[0,0],'Color','k','LineStyle','--')
%         set(gca,'box','off')
%         title('Winter Wheat')
%         
%         sub(3)=subplot(1,5,3,'fontsize',10);
%         boxplot(YactDeltastats{2,potato}(2,2:nsc)*100,groupmat(1,2:nsc),'grouporder',groupnames,'labels',{'ens','Hs','Hw','L','M'});
%         line(xlim,[0,0],'Color','k','LineStyle','--')
%         set(gca,'box','off')
%         title('Potato')
%         
%         sub(4)=subplot(1,5,4,'fontsize',10);
%         boxplot(YactDeltastats{2,sugarbeet}(2,2:nsc)*100,groupmat(1,2:nsc),'grouporder',groupnames,'labels',{'ens','Hs','Hw','L','M'});
%         line(xlim,[0,0],'Color','k','LineStyle','--')
%         set(gca,'box','off')
%         title('Sugarbeet')
%         
%         sub(5)=subplot(1,5,5,'fontsize',10);
%         boxplot(YactDeltastats{2,pea}(2,2:nsc)*100,groupmat(1,2:nsc),'grouporder',groupnames,'labels',{'ens','Hs','Hw','L','M'});
%         line(xlim,[0,0],'Color','k','LineStyle','--')
%         set(gca,'box','off')
%         title('Peas')  
% 
...
% f1synth=figure('name','Median yield changes with synthestic scenarios');%(boxplot= variation over different GCMs) 
%         sub(1)=subplot(1,5,1,'fontsize',10);
%             gindex=find(strcmp(groupmat(1,1:nsc),'Ens')==1);
%             boxplot(YactDeltastats{2,maize}(2,gindex)*100,'colors',[0.6 0.6 0.6],'symbol','+');
%             ylabel('Median yield change (%)')
%             %axis([xlim, min(YactDeltastats{2,maize}(2,:)*100)-5,max(YactDeltastats{2,maize}(2,:)*100)+5])
%             axis([xlim, -40,45])
...
% 5.2extra Vizualize WPET and yield impact with boxplots
%-------------------------------------------------------------------------
%PUBLICATION FIGURE
f11=figure('name','Median yield and WPET changes');%(boxplot= variation over different GCMs) 
        sub(1)=subplot(2,5,1,'fontsize',10);
...
% 5.3 Vizualize WPET and Yield with cumulative distribution function
%-------------------------------------------------------------------------
% ALL LINES
%PUBLICATION FIGURE 
...
% SIMPLIFIED    
%PUBLICATION FIGURE
f4=figure('name','Seasonal yield emperical CDF -Simple');
    subplot(5,2,1,'fontsize',10);
    for g=1:ngroup2
        gindex=find(strcmp(groupmat(1,1:nsc),groupnames2{1,g})==1);
        P(g)=cdfplot(reshape(Yact{2,maize}(:,gindex),[],1));
...
filename='WPETandYield median changes - GCMboxplots';
filename=fullfile(DatapathScenOut,filename);
...
filename='WPETandYield empirical CDF - simple';
filename=fullfile(DatapathScenOut,filename);
savefig(f4,filename)
...
f12=figure('name','Median DSI and TSI changes together');%(boxplot= variation over different GCMs) 
        sub(1)=subplot(2,5,1,'fontsize',10);
        boxplot(DSIDeltastats{2,maize}(2,2:nsc),groupmat(1,2:nsc),'grouporder',groupnames,'labels',groupnames,'colorgroup',groupnames,'colors',boxplotcolor,'symbol','+');
        line(xlim,[0,0],'Color','k','LineStyle','--')
        ylabel('Median DSI change (%)','fontsize',8)
        axis([xlim, -5,20])
        set(gca,'box','off')
        title('Maize','fontsize',8)
        
        sub(2)=subplot(2,5,2,'fontsize',10);
        boxplot(DSIDeltastats{2,wwheat}(2,2:nsc),groupmat(1,2:nsc),'grouporder',groupnames,'labels',groupnames,'colorgroup',groupnames,'colors',boxplotcolor,'symbol','+' );
        line(xlim,[0,0],'Color','k','LineStyle','--')
        set(gca,'box','off')
        title('Winter wheat','fontsize',8)
        
        sub(3)=subplot(2,5,3,'fontsize',5);
        boxplot(DSIDeltastats{2,potato}(2,2:nsc),groupmat(1,2:nsc),'grouporder',groupnames,'labels',groupnames,'colorgroup',groupnames,'colors',boxplotcolor,'symbol','+' );
        line(xlim,[0,0],'Color','k','LineStyle','--')
        set(gca,'box','off')
        title('Potato','fontsize',8)
        
        sub(4)=subplot(2,5,4,'fontsize',10);
        boxplot(DSIDeltastats{2,sugarbeet}(2,2:nsc),groupmat(1,2:nsc),'grouporder',groupnames,'labels',groupnames,'colorgroup',groupnames,'colors',boxplotcolor,'symbol','+' );
        line(xlim,[0,0],'Color','k','LineStyle','--')
        set(gca,'box','off')
        title('Sugar beet','fontsize',8)
        
        sub(5)=subplot(2,5,5,'fontsize',10);
        boxplot(DSIDeltastats{2,pea}(2,2:nsc),groupmat(1,2:nsc),'grouporder',groupnames,'labels',groupnames,'colorgroup',groupnames,'colors',boxplotcolor,'symbol','+' );
        line(xlim,[0,0],'Color','k','LineStyle','--')
        set(gca,'box','off')
        title('Peas','fontsize',8)    
        ...
        line(xlim,[0,0],'Color','k','LineStyle','--')
        ylabel('Median TSI change (%)','fontsize',8)
        axis([xlim, -20,5])
        set(gca,'box','off')
        title('Maize')
...
filename='TSI&DSI median changes - GCMboxplots';
filename=fullfile(DatapathScenOut,filename);
...
% PUBLICATION FIGURE
f11=figure('name','Median LGPact en LGP pot'); %(boxplot= variation over different GCMs) 
...
% ----------------------------------------------------------------------- 
    ...
    index1=find(Q_MTFyseason{1,1}(:,2)==1);
    index2=find(Q_MTFyseason{1,1}(:,2)==2);
    index3=find(Q_MTFyseason{1,1}(:,2)==3);
    index4=find(Q_MTFyseason{1,1}(:,2)==4);
    ...
    Q_MTFyseason1(:,sc)=Q_MTFyseason{1,sc}(index1,3);
    Q_MTFyseason2(:,sc)=Q_MTFyseason{1,sc}(index2,3);
    Q_MTFyseason3(:,sc)=Q_MTFyseason{1,sc}(index3,3);
    Q_MTFyseason4(:,sc)=Q_MTFyseason{1,sc}(index4,3);
    end
    
    
    clear sc index1 index2 index3 index4
...
f6=figure('name','Yearly discharge emperical CDF');
 ...
 %PUBLICATION FIGURE    
 f9=figure('name','Yearly and seasonal discharge emperical CDF');
    subplot(2,2,1,'fontsize',10);
    for i=1:nsc
        P(i)=cdfplot(Q_MTFyear2(:,i));
        hold on 
...
f1= figure('name','Median monthly discharge changes');
 ...
 f2= figure('name','Median monthly discharge changes - only future changes');
            %sub(1)=subplot(1,12,1,'fontsize',8); 
            ...
            line(xlim,[0,0],'Color','k','LineStyle','--')
            ylabel('Median monthly flow change (%)','fontsize',10)
            xlabel('1')
            axis([xlim, -60,80])
            set(gca,'XTick',[])
            set(gca,'box','off')
            
            %sub(2)=subplot(1,12,2,'fontsize',8);             
            ...
            %sub(3)=subplot(1,12,3,'fontsize',8);           
            ...
            %sub(4)=subplot(1,12,4,'fontsize',8);           
            ...
            %sub(5)=subplot(1,12,5,'fontsize',810);           
            ...
            %sub(6)=subplot(1,12,6,'fontsize',8);           
            ...
            %sub(7)=subplot(1,12,7,'fontsize',8);          
            ...
            %sub(8)=subplot(1,12,8,'fontsize',8);  
            ...
            %sub(9)=subplot(1,12,9,'fontsize',8);  
            ...
            %sub(10)=subplot(1,12,10,'fontsize',8);  
            ...
            %sub(11)=subplot(1,12,11,'fontsize',8);  
            ...
            %sub(12)=subplot(1,12,12,'fontsize',8); 
...
%% -----------------------------------------------------------------------
% % 9. CATCHMENT TRANSPIRATION COEFFICIENT (KC) IMPACT  (NOT TESTED YET!!!)
% %------------------------------------------------------------------------
% 
% % 9.1 KC calculation  
% % -----------------------------------------------------------------------
% 
%     Kc=ETaCatch./ETo;    % Kc but water content relation not filtered out
%     Kc(isnan(Kc))=1;                     % replace NaN (0/0) by 1
%     Kc2=Kc./Wr2Catch ;   % Kc with water content effect filtered out
%       
% 
% % 9.2 aggregation of results (subtotals and cumulative) 
% % ----------------------------------------------------------------------- 
% 
% % subtotals
% [Kcyear,Kcmonth,~,Kcseason,Kcymonth,~,Kcyseason]=ClimSubtotal(Date(:,1),Kc,'sum');
% [Kc2year,Kc2month,~,Kc2season,Kc2ymonth,~,Kc2yseason]=ClimSubtotal(Date(:,1),Kc2,'sum');
% [Wr2Catchyear,Wr2Catchmonth,~,Wr2Catchseason,Wr2Catchymonth,~,Wr2Catchyseason]=ClimSubtotal(Date(:,1),Wr2Catch,'sum');
% 
% % 9.3 Yearly analysis
% % ----------------------------------------------------------------------- 
% % stats per GCM over different years 
%     Kcyearstats=NaN(5,nsc);
%     Kc2yearstats=NaN(5,nsc);
%     Wr2Cyearstats=NaN(5,nsc);        
%     
%     %DOES NOT WORK YET (CAN NOT TAKE MEAN FROM STRUCTURE)
%     Kcyearstats(1,1:nsc)=mean(Kcyear(:,1:nsc));
%     Kcyearstats(2,1:nsc)=median(Kcyear(:,1:nsc));
%     Kcyearstats(3,1:nsc)=std(Kcyear(:,1:nsc));
%     Kcyearstats(4,1:nsc)=min(Kcyear(:,1:nsc));
%     Kcyearstats(5,1:nsc)=max(Kcyear(:,1:nsc));
%     
%     Kc2yearstats(1,1:nsc)=mean(Kc2year(:,1:nsc));
%     Kc2yearstats(2,1:nsc)=median(Kc2year(:,1:nsc));
%     Kc2yearstats(3,1:nsc)=std(Kc2year(:,1:nsc));
%     Kc2yearstats(4,1:nsc)=min(Kc2year(:,1:nsc));
%     Kc2yearstats(5,1:nsc)=max(Kc2year(:,1:nsc));
%     
%     Wr2Cyearstats(1,1:nsc)=mean(Wr2Catchyear(:,1:nsc));
%     Wr2Cyearstats(2,1:nsc)=median(Wr2Catchyear(:,1:nsc));
%     Wr2Cyearstats(3,1:nsc)=std(Wr2Catchyear(:,1:nsc));
%     Wr2Cyearstats(4,1:nsc)=min(Wr2Catchyear(:,1:nsc));
%     Wr2Cyearstats(5,1:nsc)=max(Wr2Catchyear(:,1:nsc));       
%     
% %  Changes of mean and median (as compared to historical mean and median) for each GCM
%     KcyearDeltastats=NaN(2,nsc);
%     Kc2yearDeltastats=NaN(2,nsc);
%     Wr2CyearDeltastats=NaN(2,nsc);
%     
%     for stat=1:2
%         KcyearDeltastats(stat,1:nsc)=(Kcyearstats(stat,1:nsc)-Kcyearstats(stat,1))./Kcyearstats(stat,1);
%         Kc2yearDeltastats(stat,1:nsc)=(Kc2yearstats(stat,1:nsc)-Kc2yearstats(stat,1))./Kc2yearstats(stat,1);
%         Wr2CyearDeltastats(stat,1:nsc)=(Wr2Cyearstats(stat,1:nsc)-Wr2Cyearstats(stat,1))./Wr2Cyearstats(stat,1);
%     end
% 
%     clear stat
% % vizualization 
%    
%  f1=figure('name','Median yearly Kc changes - GCM variation');
%         sub(1)=subplot(1,4,1:2,'fontsize',10);
%         boxplot(KcyearDeltastats(1,2:nsc)*100,groupmat(1,2:nsc),'grouporder',groupnames,'labels',groupnames);
%         line(xlim,[0,0],'Color','k','LineStyle','--')
%         ylabel('Median Kc change (%)')
%         title('Kc')
%         axis([xlim, -10,30])
%         set(gca,'box','off')
% 
%         sub(2)=subplot(1,4,3,'fontsize',10);
%         boxplot(Kc2yearDeltastats(1,2:nsc)*100,groupmat(1,2:nsc),'grouporder',groupnames,'labels',groupnames);
%         line(xlim,[0,0],'Color','k','LineStyle','--')
%         title('Kc corrected')
%         set(gca,'box','off','YTick',[])
% 
%         sub(3)=subplot(1,4,4,'fontsize',10);
%         boxplot(Wr2CyearDeltastats(1,2:nsc)*100,groupmat(1,2:nsc),'grouporder',groupnames,'labels',groupnames);
%         line(xlim,[0,0],'Color','k','LineStyle','--')
...
%                
% % stats for all GCMs & different years together (historical set excluded)
%     Kcallyearstats=NaN(5,3);
%     
%     Kcyearfut=Kcyear(:,2:nsc);%select all columns of future
%     Kc2yearfut=Kc2year(:,2:nsc);
%     Wr2Catchyearfut=Wr2Catchyear(:,2:nsc);
%     
%     Kcallyearstats(1,1)=mean(Kcyearfut(:));
%     Kcallyearstats(2,1)=median(Kcyearfut(:));
%     Kcallyearstats(3,1)=std(Kcyearfut(:));
%     Kcallyearstats(4,1)=min(Kcyearfut(:));
%     Kcallyearstats(5,1)=max(Kcyearfut(:));
%     
%     Kcallyearstats(1,2)=mean(Kc2yearfut(:));
%     Kcallyearstats(2,2)=median(Kc2yearfut(:));
%     Kcallyearstats(3,2)=std(Kc2yearfut(:));
%     Kcallyearstats(4,2)=min(Kc2yearfut(:));
%     Kcallyearstats(5,2)=max(Kc2yearfut(:));
%     
%     Kcallyearstats(1,3)=mean(Wr2Catchyearfut(:));
%     Kcallyearstats(2,3)=median(Wr2Catchyearfut(:));
%     Kcallyearstats(3,3)=std(Wr2Catchyearfut(:));
%     Kcallyearstats(4,3)=min(Wr2Catchyearfut(:));
%     Kcallyearstats(5,3)=max(Wr2Catchyearfut(:));       
%        
%     clear Kcyearfut Kc2yearfut Wr2Catchyearfut
% 
% % Change of yearly discharge as compared to historical median for all years
% 
%     KcyearDelta=(Kcyear-Kcyearstats(2,1))./Kcyearstats(2,1);
%     Kc2yearDelta=(Kc2year-Kc2yearstats(2,1))./Kc2yearstats(2,1);
%     Wr2CyearDelta=(Wr2Catchyear-Wr2Cyearstats(2,1))./Wr2Cyearstats(2,1);
% 
% % vizualization                  
% 
% f2=figure('name','Median yearly Kc changes- GCM&year variation');% boxplot = variation over different GCMs & over 30 different year)   
% 
%         sub(1)=subplot(1,4,1:2,'fontsize',10);
%         boxplot(KcyearDelta(:,1:nsc)*100,groupmat(1,1:nsc),'grouporder',groupnames2,'labels',groupnames2)
%         line(xlim,[0,0],'Color','k','LineStyle','--')
%         ylabel('Annual change from historical median (%)')
%         title('Kc')
%         axis([xlim, -100,100])
%         set(gca,'box','off')
% 
%         sub(2)=subplot(1,4,3,'fontsize',10);
%         boxplot(Kc2yearDelta(:,1:nsc)*100,groupmat(1,1:nsc),'grouporder',groupnames2,'labels',groupnames2)
%         line(xlim,[0,0],'Color','k','LineStyle','--')
%         title('Kc corrected')
%         set(gca,'box','off','YTick',[])
% 
%         sub(3)=subplot(1,4,4,'fontsize',10);
%         boxplot(Wr2CyearDelta(:,1:nsc)*100,groupmat(1,1:nsc),'grouporder',groupnames2,'labels',groupnames2)
%         line(xlim,[0,0],'Color','k','LineStyle','--')
%         title('Soil water content')
%         set(gca,'box','off','YTick',[])
% 
...
% % reorganize data in one matrix   
%     Kcymonth2=cell(1,12);
%     Kc2ymonth2=cell(1,12);
%     Wr2Cymonth2=cell(1,12);
% 
%     for m=1:12
%         mindex=find(Kcymonth{1,1}(:,2)==m);
%         for sc =1:nsc
%         Kcymonth2{1,m}(:,sc)=Kcymonth{1,sc}(mindex,3);
%         Kc2ymonth2{1,m}(:,sc)=Kc2ymonth{1,sc}(mindex,3);
%         Wr2Cymonth2{1,m}(:,sc)=Wr2Cymonth{1,sc}(mindex,3);
%         end
%     end
%     clear m 
%     
% % stats for each month and each scenario
%     Kcmonthstats=cell(2,12);
%     Kcmonthstats(1,1:12)={'jan','febr','march', 'april', 'may', 'june', 'july', 'august', 'september', 'october', 'november', 'december'};
%     
%     Kc2monthstats=cell(2,12);
%     Kc2monthstats(1,1:12)={'jan','febr','march', 'april', 'may', 'june', 'july', 'august', 'september', 'october', 'november', 'december'};
%     
%     Wr2Cmonthstats=cell(2,12);
%     Wr2Cmonthstats(1,1:12)={'jan','febr','march', 'april', 'may', 'june', 'july', 'august', 'september', 'october', 'november', 'december'};
%     
%     for m=1:12 
%         Kcmonthstats{2,m}(1,1:nsc)=mean(Kcymonth2{1,m}(:,1:nsc));
%         Kcmonthstats{2,m}(2,1:nsc)=median(Kcymonth2{1,m}(:,1:nsc));
%         Kcmonthstats{2,m}(3,1:nsc)=std(Kcymonth2{1,m}(:,1:nsc));
%         Kcmonthstats{2,m}(4,1:nsc)=min(Kcymonth2{1,m}(:,1:nsc));
%         Kcmonthstats{2,m}(5,1:nsc)=max(Kcymonth2{1,m}(:,1:nsc));
%         
%         Kc2monthstats{2,m}(1,1:nsc)=mean(Kc2ymonth2{1,m}(:,1:nsc));
%         Kc2monthstats{2,m}(2,1:nsc)=median(Kc2ymonth2{1,m}(:,1:nsc));
%         Kc2monthstats{2,m}(3,1:nsc)=std(Kc2ymonth2{1,m}(:,1:nsc));
%         Kc2monthstats{2,m}(4,1:nsc)=min(Kc2ymonth2{1,m}(:,1:nsc));
%         Kc2monthstats{2,m}(5,1:nsc)=max(Kc2ymonth2{1,m}(:,1:nsc));
%         
%         Wr2Cmonthstats{2,m}(1,1:nsc)=mean(Wr2Cymonth2{1,m}(:,1:nsc));
%         Wr2Cmonthstats{2,m}(2,1:nsc)=median(Wr2Cymonth2{1,m}(:,1:nsc));
%         Wr2Cmonthstats{2,m}(3,1:nsc)=std(Wr2Cymonth2{1,m}(:,1:nsc));
%         Wr2Cmonthstats{2,m}(4,1:nsc)=min(Wr2Cymonth2{1,m}(:,1:nsc));
%         Wr2Cmonthstats{2,m}(5,1:nsc)=max(Wr2Cymonth2{1,m}(:,1:nsc));
%     end
%     
% %  Mean changes of statistics (mean and median)for each month and each
% %  scenario
%     KcmonthDeltastats=cell(2,12);
%     KcmonthDeltastats(1,1:12)=Kcmonthstats(1,1:12);
%    
%     for m=1:12 
%         for stat=1:2
%             KcmonthDeltastats{2,m}(stat,1:nsc)=(Kcmonthstats{2,m}(stat,1:nsc)-Kcmonthstats{2,m}(stat,1))./Kcmonthstats{2,m}(stat,1);
%             Kc2monthDeltastats{2,m}(stat,1:nsc)=(Kc2monthstats{2,m}(stat,1:nsc)-Kc2monthstats{2,m}(stat,1))./Kc2monthstats{2,m}(stat,1);
%             Wr2CmonthDeltastats{2,m}(stat,1:nsc)=(Wr2Cmonthstats{2,m}(stat,1:nsc)-Wr2Cmonthstats{2,m}(stat,1))./Wr2Cmonthstats{2,m}(stat,1);
%        end
%     end
%     clear m stat
% 
% % vizualization (boxplot= variation over different GCMs)     
%     figure('name','Median monthly Kc changes')
%             sub(1)=subplot('Position',[0.05, 0.4, 0.055,0.55],'fontsize',10); 
%             boxplot(KcmonthDeltastats{2,1}(1,2:nsc)*100,groupmat(1,2:nsc),'grouporder',groupnames,'labels',groupnames);
%             line(xlim,[0,0],'Color','k','LineStyle','--')
%             ylabel('Median monthly Kc change (%)')
%             xlabel('January')
%             axis([xlim, -60,60])
%             set(gca,'XTick',[])
%             set(gca,'box','off')
%             
%             sub(2)=subplot('Position',[0.16, 0.4, 0.04,0.55],'fontsize',10); 
%             boxplot(KcmonthDeltastats{2,2}(1,2:nsc)*100,groupmat(1,2:nsc),'grouporder',groupnames,'labels',groupnames);
%             line(xlim,[0,0],'Color','k','LineStyle','--')
%             xlabel('February')           
%             set(gca,'YTick',[],'XTick',[])
%             set(gca,'box','off')
%             
%             sub(3)=subplot('Position',[0.2208, 0.4, 0.04,0.55],'fontsize',10); 
%             boxplot(KcmonthDeltastats{2,3}(1,2:nsc)*100,groupmat(1,2:nsc),'grouporder',groupnames,'labels',groupnames);
%             line(xlim,[0,0],'Color','k','LineStyle','--')
%             xlabel('March')
%             set(gca,'YTick',[],'XTick',[])
%             set(gca,'box','off')
%             
%             sub(4)=subplot('Position',[0.28, 0.4, 0.04,0.55],'fontsize',10); 
%             boxplot(KcmonthDeltastats{2,4}(1,2:nsc)*100,groupmat(1,2:nsc),'grouporder',groupnames,'labels',groupnames);
%             line(xlim,[0,0],'Color','k','LineStyle','--')
%             xlabel('April')
%             set(gca,'YTick',[],'XTick',[])
%             set(gca,'box','off')
% 
%             sub(5)=subplot('Position',[0.3355, 0.4, 0.04,0.55],'fontsize',10); 
%             boxplot(KcmonthDeltastats{2,5}(1,2:nsc)*100,groupmat(1,2:nsc),'grouporder',groupnames,'labels',groupnames);
%             line(xlim,[0,0],'Color','k','LineStyle','--')
%             xlabel('May')
%              set(gca,'YTick',[],'XTick',[])
%             set(gca,'box','off')
%             
%             sub(6)=subplot('Position',[0.401, 0.4, 0.04,0.55],'fontsize',10); 
%             boxplot(KcmonthDeltastats{2,6}(1,2:nsc)*100,groupmat(1,2:nsc),'grouporder',groupnames,'labels',groupnames);
%             line(xlim,[0,0],'Color','k','LineStyle','--')
%             xlabel('June')
%             set(gca,'YTick',[],'XTick',[])
%             set(gca,'box','off')
%             
%             title('Changes of median monthly Kc')            
%             sub(7)=subplot('Position',[0.46, 0.4, 0.04,0.55],'fontsize',10); 
%             boxplot(KcmonthDeltastats{2,7}(1,2:nsc)*100,groupmat(1,2:nsc),'grouporder',groupnames,'labels',groupnames);
%             line(xlim,[0,0],'Color','k','LineStyle','--')
%             xlabel('July')
%             set(gca,'YTick',[],'XTick',[])
%             set(gca,'box','off')
%           
%             sub(8)=subplot('Position',[0.525, 0.4, 0.04,0.55],'fontsize',10); 
%             boxplot(KcmonthDeltastats{2,8}(1,2:nsc)*100,groupmat(1,2:nsc),'grouporder',groupnames,'labels',groupnames);
%             line(xlim,[0,0],'Color','k','LineStyle','--')
%             xlabel('August')
%             set(gca,'YTick',[],'XTick',[])
%             set(gca,'box','off')
%           
%             sub(9)=subplot('Position',[0.587, 0.4, 0.04,0.55],'fontsize',10); 
%             boxplot(KcmonthDeltastats{2,9}(1,2:nsc)*100,groupmat(1,2:nsc),'grouporder',groupnames,'labels',groupnames);
%             line(xlim,[0,0],'Color','k','LineStyle','--')
%             xlabel('September')
%             set(gca,'YTick',[],'XTick',[])
%             set(gca,'box','off')
%               
%             sub(10)=subplot('Position',[0.64, 0.4, 0.04,0.55],'fontsize',10); 
%             boxplot(KcmonthDeltastats{2,10}(1,2:nsc)*100,groupmat(1,2:nsc),'grouporder',groupnames,'labels',groupnames);
%             line(xlim,[0,0],'Color','k','LineStyle','--')
%             xlabel('October')  
%             set(gca,'YTick',[],'XTick',[])
%             set(gca,'box','off')
%           
%             sub(11)=subplot('Position',[0.725, 0.4, 0.04,0.55],'fontsize',10); 
%             boxplot(KcmonthDeltastats{2,11}(1,2:nsc)*100,groupmat(1,2:nsc),'grouporder',groupnames,'labels',groupnames);
%             line(xlim,[0,0],'Color','k','LineStyle','--')
%             xlabel('November')
%             set(gca,'YTick',[],'XTick',[])
%             set(gca,'box','off')
%           
%             sub(12)=subplot('Position',[0.785, 0.4, 0.04,0.55],'fontsize',10); 
%             boxplot(KcmonthDeltastats{2,12}(1,2:nsc)*100,groupmat(1,2:nsc),'grouporder',groupnames,'labels',groupnames);
%             line(xlim,[0,0],'Color','k','LineStyle','--')
%             xlabel('December')
%             set(gca,'YTick',[],'XTick',[])
%             set(gca,'box','off')     
...
%             subplot('Position',[0.06, 0.1, 0.76,0.2],'fontsize',12);
%                 for i=1:12
%                 HistValue(i,1)=Kcmonthstats{2,i}(1,2);
%                 end
%             bar(1:12,HistValue)
%             ylabel('Median monthly Kc(mm/mm)','fontsize',10)
%             axis([0.5,12.5, ylim])
%             set(gca,'XTick',1:12)
%             set(gca,'box','off')
%             clear sub i 
%             
%      figure('name','Median monthly Kc2 changes')
%             sub(1)=subplot('Position',[0.05, 0.4, 0.055,0.55],'fontsize',10); 
%             boxplot(Kc2monthDeltastats{2,1}(1,2:nsc)*100,groupmat(1,2:nsc),'grouporder',groupnames,'labels',groupnames);
%             line(xlim,[0,0],'Color','k','LineStyle','--')
%             ylabel('Median monthly Kc2 change (%)')
%             xlabel('January')
%             axis([xlim, -60,60])
%             set(gca,'XTick',[])
%             set(gca,'box','off')
%             
%             sub(2)=subplot('Position',[0.16, 0.4, 0.04,0.55],'fontsize',10); 
%             boxplot(Kc2monthDeltastats{2,2}(1,2:nsc)*100,groupmat(1,2:nsc),'grouporder',groupnames,'labels',groupnames);
%             line(xlim,[0,0],'Color','k','LineStyle','--')
%             xlabel('February')           
%             set(gca,'YTick',[],'XTick',[])
%             set(gca,'box','off')
%             
%             sub(3)=subplot('Position',[0.2208, 0.4, 0.04,0.55],'fontsize',10); 
%             boxplot(Kc2monthDeltastats{2,3}(1,2:nsc)*100,groupmat(1,2:nsc),'grouporder',groupnames,'labels',groupnames);
%             line(xlim,[0,0],'Color','k','LineStyle','--')
%             xlabel('March')
%             set(gca,'YTick',[],'XTick',[])
%             set(gca,'box','off')
%             
%             sub(4)=subplot('Position',[0.28, 0.4, 0.04,0.55],'fontsize',10); 
%             boxplot(Kc2monthDeltastats{2,4}(1,2:nsc)*100,groupmat(1,2:nsc),'grouporder',groupnames,'labels',groupnames);
%             line(xlim,[0,0],'Color','k','LineStyle','--')
%             xlabel('April')
%             set(gca,'YTick',[],'XTick',[])
%             set(gca,'box','off')
% 
%             sub(5)=subplot('Position',[0.3355, 0.4, 0.04,0.55],'fontsize',10); 
%             boxplot(Kc2monthDeltastats{2,5}(1,2:nsc)*100,groupmat(1,2:nsc),'grouporder',groupnames,'labels',groupnames);
%             line(xlim,[0,0],'Color','k','LineStyle','--')
%             xlabel('May')
%              set(gca,'YTick',[],'XTick',[])
%             set(gca,'box','off')
%             
%             sub(6)=subplot('Position',[0.401, 0.4, 0.04,0.55],'fontsize',10); 
%             boxplot(Kc2monthDeltastats{2,6}(1,2:nsc)*100,groupmat(1,2:nsc),'grouporder',groupnames,'labels',groupnames);
%             line(xlim,[0,0],'Color','k','LineStyle','--')
%             xlabel('June')
%             set(gca,'YTick',[],'XTick',[])
%             set(gca,'box','off')
%             
%             title('Changes of median monthly Kc2')            
%             sub(7)=subplot('Position',[0.46, 0.4, 0.04,0.55],'fontsize',10); 
%             boxplot(Kc2monthDeltastats{2,7}(1,2:nsc)*100,groupmat(1,2:nsc),'grouporder',groupnames,'labels',groupnames);
%             line(xlim,[0,0],'Color','k','LineStyle','--')
%             xlabel('July')
%             set(gca,'YTick',[],'XTick',[])
%             set(gca,'box','off')
%           
%             sub(8)=subplot('Position',[0.525, 0.4, 0.04,0.55],'fontsize',10); 
%             boxplot(Kc2monthDeltastats{2,8}(1,2:nsc)*100,groupmat(1,2:nsc),'grouporder',groupnames,'labels',groupnames);
%             line(xlim,[0,0],'Color','k','LineStyle','--')
%             xlabel('August')
%             set(gca,'YTick',[],'XTick',[])
%             set(gca,'box','off')
%           
%             sub(9)=subplot('Position',[0.587, 0.4, 0.04,0.55],'fontsize',10); 
%             boxplot(Kc2monthDeltastats{2,9}(1,2:nsc)*100,groupmat(1,2:nsc),'grouporder',groupnames,'labels',groupnames);
%             line(xlim,[0,0],'Color','k','LineStyle','--')
%             xlabel('September')
%             set(gca,'YTick',[],'XTick',[])
%             set(gca,'box','off')
%               
%             sub(10)=subplot('Position',[0.64, 0.4, 0.04,0.55],'fontsize',10); 
%             boxplot(Kc2monthDeltastats{2,10}(1,2:nsc)*100,groupmat(1,2:nsc),'grouporder',groupnames,'labels',groupnames);
%             line(xlim,[0,0],'Color','k','LineStyle','--')
%             xlabel('October')  
%             set(gca,'YTick',[],'XTick',[])
%             set(gca,'box','off')
%           
%             sub(11)=subplot('Position',[0.725, 0.4, 0.04,0.55],'fontsize',10); 
%             boxplot(Kc2monthDeltastats{2,11}(1,2:nsc)*100,groupmat(1,2:nsc),'grouporder',groupnames,'labels',groupnames);
%             line(xlim,[0,0],'Color','k','LineStyle','--')
%             xlabel('November')
%             set(gca,'YTick',[],'XTick',[])
%             set(gca,'box','off')
%           
%             sub(12)=subplot('Position',[0.785, 0.4, 0.04,0.55],'fontsize',10); 
%             boxplot(Kc2monthDeltastats{2,12}(1,2:nsc)*100,groupmat(1,2:nsc),'grouporder',groupnames,'labels',groupnames);
%             line(xlim,[0,0],'Color','k','LineStyle','--')
%             xlabel('December')
%             set(gca,'YTick',[],'XTick',[])
%             set(gca,'box','off')     
...
%             subplot('Position',[0.06, 0.1, 0.76,0.2],'fontsize',12);
%                 for i=1:12
%                 HistValue(i,1)=Kc2monthstats{2,i}(1,2);
%                 end
%             bar(1:12,HistValue)
%             ylabel('Median monthly Kc2(mm/mm)','fontsize',10)
%             axis([0.5,12.5, ylim])
%             set(gca,'XTick',1:12)
%             set(gca,'box','off')  
%             clear sub i 
%             
%    figure('name','Median monthly Wr2catch changes')
%             sub(1)=subplot('Position',[0.05, 0.4, 0.055,0.55],'fontsize',10); 
%             boxplot(Wr2CmonthDeltastats{2,1}(1,2:nsc)*100,groupmat(1,2:nsc),'grouporder',groupnames,'labels',groupnames);
%             line(xlim,[0,0],'Color','k','LineStyle','--')
%             ylabel('Median monthly Wr2C change (%)')
%             xlabel('January')
%             axis([xlim, -60,60])
%             set(gca,'XTick',[])
%             set(gca,'box','off')
%             
%             sub(2)=subplot('Position',[0.16, 0.4, 0.04,0.55],'fontsize',10); 
%             boxplot(Wr2CmonthDeltastats{2,2}(1,2:nsc)*100,groupmat(1,2:nsc),'grouporder',groupnames,'labels',groupnames);
%             line(xlim,[0,0],'Color','k','LineStyle','--')
%             xlabel('February')           
%             set(gca,'YTick',[],'XTick',[])
%             set(gca,'box','off')
%             
%             sub(3)=subplot('Position',[0.2208, 0.4, 0.04,0.55],'fontsize',10); 
%             boxplot(Wr2CmonthDeltastats{2,3}(1,2:nsc)*100,groupmat(1,2:nsc),'grouporder',groupnames,'labels',groupnames);
%             line(xlim,[0,0],'Color','k','LineStyle','--')
%             xlabel('March')
%             set(gca,'YTick',[],'XTick',[])
%             set(gca,'box','off')
%             
%             sub(4)=subplot('Position',[0.28, 0.4, 0.04,0.55],'fontsize',10); 
%             boxplot(Wr2CmonthDeltastats{2,4}(1,2:nsc)*100,groupmat(1,2:nsc),'grouporder',groupnames,'labels',groupnames);
%             line(xlim,[0,0],'Color','k','LineStyle','--')
%             xlabel('April')
%             set(gca,'YTick',[],'XTick',[])
%             set(gca,'box','off')
% 
%             sub(5)=subplot('Position',[0.3355, 0.4, 0.04,0.55],'fontsize',10); 
%             boxplot(Wr2CmonthDeltastats{2,5}(1,2:nsc)*100,groupmat(1,2:nsc),'grouporder',groupnames,'labels',groupnames);
%             line(xlim,[0,0],'Color','k','LineStyle','--')
%             xlabel('May')
%              set(gca,'YTick',[],'XTick',[])
%             set(gca,'box','off')
%             
%             sub(6)=subplot('Position',[0.401, 0.4, 0.04,0.55],'fontsize',10); 
%             boxplot(Wr2CmonthDeltastats{2,6}(1,2:nsc)*100,groupmat(1,2:nsc),'grouporder',groupnames,'labels',groupnames);
%             line(xlim,[0,0],'Color','k','LineStyle','--')
%             xlabel('June')
%             set(gca,'YTick',[],'XTick',[])
%             set(gca,'box','off')
%             
%             title('Changes of median monthly Wr2C')            
%             sub(7)=subplot('Position',[0.46, 0.4, 0.04,0.55],'fontsize',10); 
%             boxplot(Wr2CmonthDeltastats{2,7}(1,2:nsc)*100,groupmat(1,2:nsc),'grouporder',groupnames,'labels',groupnames);
%             line(xlim,[0,0],'Color','k','LineStyle','--')
%             xlabel('July')
%             set(gca,'YTick',[],'XTick',[])
%             set(gca,'box','off')
%           
%             sub(8)=subplot('Position',[0.525, 0.4, 0.04,0.55],'fontsize',10); 
%             boxplot(Wr2CmonthDeltastats{2,8}(1,2:nsc)*100,groupmat(1,2:nsc),'grouporder',groupnames,'labels',groupnames);
%             line(xlim,[0,0],'Color','k','LineStyle','--')
%             xlabel('August')
%             set(gca,'YTick',[],'XTick',[])
%             set(gca,'box','off')
%           
%             sub(9)=subplot('Position',[0.587, 0.4, 0.04,0.55],'fontsize',10); 
%             boxplot(Wr2CmonthDeltastats{2,9}(1,2:nsc)*100,groupmat(1,2:nsc),'grouporder',groupnames,'labels',groupnames);
%             line(xlim,[0,0],'Color','k','LineStyle','--')
%             xlabel('September')
%             set(gca,'YTick',[],'XTick',[])
%             set(gca,'box','off')
%               
%             sub(10)=subplot('Position',[0.64, 0.4, 0.04,0.55],'fontsize',10); 
%             boxplot(Wr2CmonthDeltastats{2,10}(1,2:nsc)*100,groupmat(1,2:nsc),'grouporder',groupnames,'labels',groupnames);
%             line(xlim,[0,0],'Color','k','LineStyle','--')
%             xlabel('October')  
%             set(gca,'YTick',[],'XTick',[])
%             set(gca,'box','off')
%           
%             sub(11)=subplot('Position',[0.725, 0.4, 0.04,0.55],'fontsize',10); 
%             boxplot(Wr2CmonthDeltastats{2,11}(1,2:nsc)*100,groupmat(1,2:nsc),'grouporder',groupnames,'labels',groupnames);
%             line(xlim,[0,0],'Color','k','LineStyle','--')
%             xlabel('November')
%             set(gca,'YTick',[],'XTick',[])
%             set(gca,'box','off')
%           
%             sub(12)=subplot('Position',[0.785, 0.4, 0.04,0.55],'fontsize',10); 
%             boxplot(Wr2CmonthDeltastats{2,12}(1,2:nsc)*100,groupmat(1,2:nsc),'grouporder',groupnames,'labels',groupnames);
%             line(xlim,[0,0],'Color','k','LineStyle','--')
%             xlabel('December')
%             set(gca,'YTick',[],'XTick',[])
%             set(gca,'box','off')     
...
%             subplot('Position',[0.06, 0.1, 0.76,0.2],'fontsize',12);
%                 for i=1:12
%                 HistValue(i,1)=Wr2Cmonthstats{2,i}(1,2);
%                 end
%             bar(1:12,HistValue)
%             ylabel('Median monthly Wr2C(mm/mm)','fontsize',10)
%             axis([0.5,12.5, ylim])
%             set(gca,'XTick',1:12)
%             set(gca,'box','off')  
%             clear sub i 
...
% 10.1 Summary of annual discharge 
% -----------------------------------------------------------------------  
%  median and relative changes to median
...
% 10.2 Summary of MOnthly total flow changes
% ----------------------------------------------------------------------- 
...
% 10.2 Summary of Crop development and production parameters
% -----------------------------------------------------------------------     
% median and absolute changes to median
...
for g=1:ngroup
    ...
    for c=1:length(name)
        ...
        HeadersRows={name{1,c};'Seasonal crop yield (ton/ha)';'WPET (kg/m³)';'LGPact (days)';'DSI (%)';'TSI (%)'};
        ...
        row4=[DSIstats{2,cindex}(2,1),min(DSIDeltastats{2,cindex}(2,gindex)),median(DSIDeltastats{2,cindex}(2,gindex)),max(DSIDeltastats{2,cindex}(2,gindex))];
...
% 10.4 Summary of CV yield and WPET
% ----------------------------------------------------------------------- 
name={'Maize','WinterWheat','Potato','Sugarbeet','Pea'};
...
clear c cindex g gindex DataMatrix row1 row2 row3 row4

% 10.5 Summary of variability yield and WPET
% ----------------------------------------------------------------------- 
name={'Maize','WinterWheat','Potato','Sugarbeet','Pea'};
...
clear filename c cindex g gindex DataMatrix 
% %% -----------------------------------------------------------------------
% % % 11. EXTRA: DETERMINATION OF EXTENSION OF GDD 
% % %------------------------------------------------------------------------
% 
...
% % ----------------------------------------------------------------------- 
% 
% % OPTION 1 : TARGET = MEDIAN ACTUAL MATURITY DATE OF HISTORICAL TIMESERIES
% 
...
% %% -----------------------------------------------------------------------
% % % 12. FIND YEAR OF MEDIAN CROP YIELD 
% % %------------------------------------------------------------------------
