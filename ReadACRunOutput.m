...
function [output]= ReadACRunOutput(Datapath)
...
Datafile=dir(fullfile(Datapath,'*run.out'));

%Define the format of data in this files
Readingformat = '%f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f' ;
...
% Read file   
    ...
    %2.2 read this file    
       % read headerlines
         for i=1:5 
            TextLine=fgetl(fid);% read the first 5 lines but skip them
            clear TextLine
         end
       ...
       % read real data line by line
            ...
            TextLine=fgetl(fid); %get a textline from the file 
               ...
               while isempty(TextLine)==0 %as long there is no blank space in TextLine (blank space indicating the end of a project)
                    ...
                    output{2,filenumb} (linecounter,1:37) = LineData'; % write the data of this line
